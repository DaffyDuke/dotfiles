...
sudo apt install -y \
  ...
  p7zip parted pass patch pcp perf-tools-unstable pgtop pidgin pidgin-skype pidgin-hangouts pidgin-encryption pidgin-openpgp pidgin-gnome-keyring pinentry-curses pinentry-tty pidcat planfacile plank playonlinux postgresql-client psensor pssh putty-tools python python3 python3-pip python3-dev python3-virtualenv pwgen \
  qarte qemu qtpass \
