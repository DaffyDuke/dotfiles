...
Python()
{
  ...
  for pkg in bpytop betago configobj docopt git-pull-request grip icdiff jsonnet kapitan litecli mycli search-that-hash shodan spotify-cli-linux tenserflow terminaltables virtualenv
  do
