...
Packages()
{
  ...
  sudo apt install -y \
    ...
    easytag eatmydata ethstatus ethtool ettercap-graphical evince evolution evolution-ews extrace exuberant-ctags \
...
Rust()
{
  ...
  for rustpkg in bat delta-git dog dust dutree erdtree fd-find gping just himalaya kubie mdcat navi ripgrep spotify-tui trippy viu
  do
