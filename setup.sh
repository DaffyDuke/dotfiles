...
Packages()
{
  ...
  sudo apt install -y \
    ...
    s3cmd scribus seahorse scdaemon shellcheck shotwell shutter simple-scan smartmontools sound-juicer sosreport spectre-meltdown-checker sshfs sshpass sslscan strace stunnel4 synaptic sysstat \
