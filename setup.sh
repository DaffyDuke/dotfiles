...
Packages()
{
  ...
  sudo apt install -y \
    ...
    s3cmd screen screenkey scribus seahorse scdaemon shotwell sshuttle simple-scan smartmontools sound-juicer sosreport source-highlight spectre-meltdown-checker speedtest-cli sshfs ssg-base sshpass sslscan socat strace stunnel4 synaptic synfigstudio sysstat \
