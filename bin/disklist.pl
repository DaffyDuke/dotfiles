...
my $query_class="all";
my $query_component="";
my $accept_multipath=0;           # 1 = single      ; 2 = multipath    ; 3 = multipath + single
my $accept_multipath_mode=0;      # 1 = passive     ; 2 = active       ; 3 = active + passive
my $accept_partitioned=0;         # 1 = unpartioned ; 2 = partitioned  ; 3 = unpartitioned  + partitioned
my $accept_disk=0;                # 1 = hdd         ; 2 = ssd          ; 4 = nvme  ;           8 = unknown
my $output_columns="pzdDUSR";
my $output_layout="col"; 
...
sub prepareOutputLayout() {
   my $ocol;
   foreach my $col (split //, $output_columns) {
      my $owner    = "";
      my $info     = "";
      my $title    = "";
      my $align    = "left";
